...
namespace EducationPlatform.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240606011611_AddingClasses")]
            ...
            modelBuilder.Entity("EducationPlatform.Core.Entities.Classroom", b =>
                {
                    ...
                    b.Property<Guid?>("UserClassConcludedId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserClassConcludedId");
            ...
            modelBuilder.Entity("EducationPlatform.Core.Entities.Classroom", b =>
                {
                    ...
                    b.HasOne("EducationPlatform.Core.Entities.UserClassConcluded", "UserClassConcluded")
                        .WithMany()
                        .HasForeignKey("UserClassConcludedId");
